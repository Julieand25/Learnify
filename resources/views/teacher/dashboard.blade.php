        ...
        <div class="content">
            ...
            <div class="table-section">
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><div class="avatar-placeholder">E</div></td>
                            <td>Eden</td>
                            <td>Physics</td>
                            <td>
                        ...
                        <tr>
                            <td><div class="avatar-placeholder">A</div></td>
                            <td>Abdullah</td>
                            <td>Physics</td>
                            <td>
                                <div class="progress-links">
                        ...
                        <tr>
                            <td><div class="avatar-placeholder">N</div></td>
                            <td>Najmi</td>
                            <td>Physics</td>
                            <td>
                                <div class="progress-links">
                        ...
                        <tr>
                            <td><div class="avatar-placeholder">H</div></td>
                            <td>Hanif</td>
                            <td>Physics</td>
                            <td>
                                <div class="progress-links">
                        ...
                        <tr>
                            <td><div class="avatar-placeholder">M</div></td>
                            <td>Muhammad</td>
                            <td>Physics</td>
                            <td>
                                <div class="progress-links">
